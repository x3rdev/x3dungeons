...
public class ZombieDungeonStructure extends StructureBase{
    ...
    public IStartFactory getStartFactory() {
        return ZombieDungeonStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            VillageConfig villageConfig = new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(new ResourceLocation(X3DUNGEONS.MOD_ID, "zombie_dungeon/start_pool")), 10);
